...
class MarkerPublisher(Node):
    ...
    def __init__(self):
        ...
        self.marker_pub_ = self.create_publisher(Marker , "/est_person_marker" , 1 )
        
        self.coordinates = self.create_subscription(Point , "/person_estimate_coor", self.marker_callback , 1)
    ...
    def marker_callback(self, coordinates: Point):
        ...
        esti_coordinates = Point()
        # x_coor = coordinates.x * 0.01
        # y_coor = coordinates.y * 0.01

        # esti_coordinates.x = coordinates.data[0]
        # esti_coordinates.y = coordinates.data[1]
        # esti_coordinates.z = 0.0
